...
echo -e "\e[33mWarning: \e[0mRun this script in the same directory.\n"
sleep 5

echo -e "\e[33mWarning: \e[0mEdit './env/gentoo-install-env-1.conf'\nbefore running this script.\n"
sleep 5
...
source ./env/gentoo-install-env-1.conf &&

echo -e "\n    \e[32m==> Step 1: \e[0mnet-setup\n"; sleep 1
net-setup &&

echo -e "\n    \e[32m==> Step 2: \e[0mTo back up '/etc/resolv.conf'\n"; sleep 1
mv -v /etc/resolv.conf{,.bak};

echo -e "\n    \e[32m==> Step 3: \e[0mTo replace nameserver in '/etc/resolv.conf'\n"; sleep 1
sed -i "s|nameserver.*|nameserver ${nameserver}|g" /etc/resolv.conf &&

echo -e "\n    \e[32m==> Step 4: \e[0mTo generate the fdisk script\n"; sleep 1
echo -e "g\nn\n1\n\n+${size_efi_parition}\nt\n1\nn\n2\n\n+${size_boot_parition}\nn\n3\n\n+${size_swap_parition}\nn\n4\n\n\nw" > ./tmp/gentoo-install-fdisk.txt &&

echo -e "\n    \e[32m==> Step 5: \e[0mTo partition the disk\n"; sleep 1
cat ./tmp/gentoo-install-fdisk.txt | fdisk ${path_disk} &&

echo -e "\n    \e[32m==> Step 6: \e[0mTo create file systems\n"; sleep 1
...
echo -e "\n    \e[32m==> Step 7: \e[0mTo create swapfile\n"; sleep 1
...
echo -e "\n    \e[32m==> Step 9: \e[0mTo set the date and the time\n"; sleep 1
hwclock --systohc;
date ${date}

echo -e "\n    \e[32m==> Step 10: To enter '/mnt/gentoo'\n"; sleep 1
cd /mnt/gentoo &&
pwd;

echo -e "\n    \e[32m==> Step 11: To download the stage file\n"; sleep 1
links ${address_stage3} &&

echo -e "\n    \e[32m==> Step 12: To extract the stage file\n"; sleep 1
tar xpvf *.tar.xz --xattrs-include='*.*' --numeric-owner &&

echo -e "\n    \e[32m==> Step 13: To copy the Gentoo repository configuration file\n"; sleep 1
mkdir -p -v /mnt/gentoo/etc/portage/repos.conf;
cp -v /mnt/gentoo/usr/share/portage/config/repos.conf /mnt/gentoo/etc/portage/repos.conf/gentoo.conf &&

echo -e "\n    \e[32m==> Step 14: To replace the sync-uri variable\n"; sleep 1
sed -i "s|rsync:\/\/rsync.gentoo.org\/gentoo-portage|${address_rsync}|g" /mnt/gentoo/etc/portage/repos.conf/gentoo.conf &&

echo -e "\n    \e[32m==> Step 15: To copy DNS info\n"; sleep 1
cp --dereference /etc/resolv.conf /mnt/gentoo/etc/ &&

echo -e "\n    \e[32m==> Step 16: To mount the necessary filesystems\n"; sleep 1
...
echo -e "\n    \e[32m==> Step 17: To enter the new environment\n"; sleep 1
