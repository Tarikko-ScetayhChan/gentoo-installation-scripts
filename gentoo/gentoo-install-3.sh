...
echo -e "\n\e[32m==> Step 1 of 14: \e[0mTo set the environment variables\n"; sleep 1
...
echo -e "\n\e[32m==> Step 3 of 14: \e[0mTo create the fstab file\n"; sleep 1
emerge genfstab &&
cp -v /etc/fstab{,.bak};
...
echo -e "\n\e[32m==> Step 4 of 14: \e[0mTo set the hostname\n"; sleep 1
echo "${hostname}" > /etc/hostname &&
echo -e "\e[32m\n/etc/hostname\n-----------------------------------------------------\e[0m";
cat /etc/hostname;
echo -e "\e[32m-----------------------------------------------------\e[0m";

echo -e "\n\e[32m==> Step 5 of 14: \e[0mTo set hosts\n"; sleep 1
mv -v /etc/hosts{,.bak};
...
echo -e "\n\e[32m==> Step 6 of 14: \e[0mTo install dhcpcd\n"; sleep 1
emerge net-misc/dhcpcd &&

echo -e "\n\e[32m==> Step 7 of 14: \e[0mTo enable dhcpcd service\n"; sleep 1
rc-update add dhcpcd default &&
rc-service dhcpcd start;

echo -e "\n\e[32m==> Step 8 of 14: \e[0mTo set the root password\n"; sleep 1
passwd &&

echo -e "\n\e[32m==> Step 9 of 14: \e[0mTo install system tools\n"; sleep 1
emerge app-admin/sysklogd sys-process/cronie sys-apps/mlocate app-shells/bash-completion net-misc/chrony sys-fs/xfsprogs sys-fs/e2fsprogs sys-fs/dosfstools sys-fs/btrfs-progs sys-fs/zfs sys-fs/jfsutils sys-fs/dosfstools net-dialup/ppp net-wireless/iw net-wireless/wpa_supplicant virtual/man dev-vcs/git www-client/links app-misc/neofetch

echo -e "\n\e[32m==> Step 10 of 14: \e[0mTo enable system tool services\n"; sleep 1
rc-update add sysklogd default &&
rc-update add cronie default &&
rc-update add sshd default &&
rc-update add chronyd default &&

echo -e "\n\e[32m==> Step 11 of 14: \e[0mTo install grub\n"; sleep 1
emerge sys-boot/grub &&

echo -e "\n\e[32m==> Step 12 of 14: \e[0mTo install grub files\n"; sleep 1
grub-install --target=${grub_install_target} --efi-directory=/boot/efi --bootloader-id=${grub_install_bootloader_id} &&

echo -e "\n\e[32m==> Step 13 of 14: \e[0mTo generate grub configuration\n"; sleep 1
grub-mkconfig -o /boot/grub/grub.cfg &&
echo -e "\e[32m\n/boot/grub/grub.cfg\n-----------------------------------------------------\e[0m";
cat /boot/grub/grub.cfg;
echo -e "\e[32m-----------------------------------------------------\e[0m";

echo -e "\n\e[32m==> Step 14 of 14: \e[0mTo exit the chrooting\n"; sleep 1
exit